...
layers.reverse(); }
        for (var i = 0, len = layers.length; i < len; i++) {
            ...
            if (layer.displayInLayerSwitcher) {
                ...
                inputElem.name = (baseLayer) ? this.id + "_baseLayers" : this.id + "_overlays";
                ...
                if (baseLayer) {
                  OpenLayers.Element.addClass(inputElem, "olBaseLayer");
                }
                else {
                  OpenLayers.Element.addClass(inputElem, "olOverlay");
                }
