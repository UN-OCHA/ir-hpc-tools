    ...
    if (!empty($gid)) {
        ...
        if ($og_group->type == 'hr_operation') {
          ...
          if ($og_group->nid == 77) { // Nid of the Colombia operation
            $variables['logo'] = '/sites/all/themes/registries/assets/images/salahumanitaria_logo.png';
          }
        ...
        elseif ($og_group->type == 'hr_disaster') {
          ...
          if ($glide == 'EP-2014-000041-GIN') {
            $variables['logo'] = '/sites/all/themes/registries/assets/images/unmeer_logo.png';
          }
        }
